...
const config = TOOLS_CONFIG["schema-validator"];
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: config.title,
    description: config.description,
    url: "https://jsonstudio-app.web.app/schema-validator",
...
export default function SchemaValidatorPage() {
  ...
  return (
    <>
      ...
      <JsonStudioApp initialView="schema" currentToolKey="schema-validator" />
    </>
  );
}
